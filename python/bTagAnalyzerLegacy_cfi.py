...
bTagAnalyzerLegacy = cms.EDAnalyzer("BTagAnalyzerLegacy",
    ...
    combinedMVABJetTags = cms.string('combinedMVABJetTags'),
    combinedMVABJetTagsNEW = cms.string('combinedMVABJetTagsNEW'),
    combinedMVABJetTagsETH = cms.string('combinedMVABJetTagsETH'),
